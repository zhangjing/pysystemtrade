...
CTP_IS_ERROR = list(CTP_ERROR_TYPES.keys())
...
class ctpClient(object):
    ...
    def __init__(
        self, ctpconnection: connectionCTP, log: pst_logger = logtoscreen("ibClient")
    ):
        ...
        self._ctp_connnection = ctpconnection
        self._log = log
    ...
    def ctp_connection(self) -> connectionCTP:
        return self._ctp_connnection

    @property
    def ctp(self) -> CTP:
        return self.ctp_connection.ctp
